...
}()); var now = -1; var resLength = 0; var thisSearch = 'https://www.baidu.com/s?wd='; var thisSearchIcon = '/images/baidu.png'; var storage = window.localStorage; if (!storage.stopHot) { storage.stopHot = true }
...
$(function () {
    var search = { data: [{ name: '百度', img: '/images/baidu.png', url: 'https://www.baidu.com/s?wd=' }, { name: 'Google', img: '/images/google.png', url: 'https://www.google.com/search?q=' }, { name: '360搜', img: '/images/360.png', url: 'https://www.so.com/s?q=' }, { name: '搜狗', img: '/images/sougou.png', url: 'https://www.sogou.com/web?query=' }, { name: 'Bing', img: '/images/bing.png', url: 'https://bing.com/search?q=' }, { name: 'YaHoo', img: '/images/yahoo.png', url: 'https://search.yahoo.com/search?p=' }, { name: '神马', img: '/images/shenma.png', url: 'http://quark.sm.cn/s?q=' }, { name: '秘迹', img: '/images/miji.png', url: 'https://mijisou.com/?q=' }, { name: 'Duckgo', img: '/images/Duckduckgo.png', url: 'https://duckduckgo.com/?q=' }, { name: 'YaHooJP', img: '/images/yahoojp.png', url: 'https://search.yahoo.co.jp/search?p=' }, { name: 'Lookao', img: '/images/lookao.png', url: 'https://lookao.com/search?q=' }, { name: 'Yandex', img: '/images/yandex.png', url: 'https://yandex.com/search/?text=' }, { name: 'AOl', img: '/images/aol.png', url: 'http://search.aol.com/aol/search?q=' }, { name: 'Yippy', img: '/images/yippy.png', url: 'https://yippy.com/search?query=' }, { name: 'Startpage', img: '/images/startpage.png', url: 'https://www.startpage.com/do/dsearch?query=' }, { name: 'Ecosia', img: '/images/Ecosia.png', url: 'https://www.ecosia.org/search?q=' }, { name: 'Peekier', img: '/images/peekier.png', url: 'https://peekier.com/#!' }, { name: 'Qwant', img: '/images/qwant.png', url: 'https://www.qwant.com/?q=' }, { name: 'MetaGer', img: '/images/metager.png', url: 'https://metager.de/meta/meta.ger3?eingabe=' }, { name: 'Dogpile', img: '/images/dogpile.png', url: 'https://www.dogpile.com/serp?q=' }, { name: 'Mag[i]', img: '/images/magi.png', url: 'https://magi.com/search?q=' }, { name: 'Goobe', img: '/images/goobe.png', url: 'https://goobe.io/search.aspx?k=' }, { name: 'Torrentz2', img: '/images/torrentz2.png', url: 'https://torrentz2.eu/search?f=' }, { name: 'Acg搜', img: '/images/acgsou.png', url: 'http://www.acgsou.com/search.php?keyword=' }] }
